...
try {
		Debug.PushSubsStack("Background_MouseClicked (b4xdialog) ","b4xdialog",23,__ref.getField(false, "ba"),__ref,245);
...
Debug.JustUpdateDeviceLine();
b4xdialog.__c.runVoidMethod ("LogImpl","919922980",RemoteObject.concat(RemoteObject.createImmutable("Time: "),(RemoteObject.solve(new RemoteObject[] {b4xdialog.__c.getField(false,"DateTime").runMethod(true,"getNow"),_n}, "-",1, 2))),0);
