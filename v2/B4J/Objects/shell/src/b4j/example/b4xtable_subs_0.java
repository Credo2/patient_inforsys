...
try {
		Debug.PushSubsStack("AddColumn (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,592);
...
try {
		Debug.PushSubsStack("AddColumnToCLV (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,584);
...
try {
		Debug.PushSubsStack("Base_Resize (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,141);
...
try {
		Debug.PushSubsStack("BuildLayoutsCache (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,616);
...
try {
		Debug.PushSubsStack("BuildQuery (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,338);
...
try {
		Debug.PushSubsStack("CalculateWidths (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,562);
...
try {
		Debug.PushSubsStack("Cell_MouseClicked (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,751);
...
try {
		Debug.PushSubsStack("CellClicked (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,780);
...
try {
		Debug.PushSubsStack("CheckAndRemoveColumnThatWasAddedToIncorrectParent (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,280);
...
try {
		Debug.PushSubsStack("Clear (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,146);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","99306132",RemoteObject.createImmutable("closing old db."),0);
...
try {
		Debug.PushSubsStack("ClearDataView (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,401);
...
try {
		Debug.PushSubsStack("ClearNavigationState (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,172);
...
try {
		Debug.PushSubsStack("ColumnToSQLType (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,708);
...
try {
		Debug.PushSubsStack("CreateCellViews (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,713);
...
try {
		Debug.PushSubsStack("CreateColumnLayouts (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,622);
...
try {
		Debug.PushSubsStack("CreateDataView (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,392);
...
try {
		Debug.PushSubsStack("CreateTable (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,692);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,104);
...
try {
		Debug.PushSubsStack("GetColumn (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,540);
...
try {
		Debug.PushSubsStack("getCurrentPage (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,899);
...
try {
		Debug.PushSubsStack("getFirstRowIndex (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,889);
...
try {
		Debug.PushSubsStack("GetLabelFromColumn (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,557);
...
try {
		Debug.PushSubsStack("GetRow (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,862);
...
try {
		Debug.PushSubsStack("getRowsPerPage (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,894);
...
try {
		Debug.PushSubsStack("getSize (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,962);
...
try {
		Debug.PushSubsStack("HeaderClicked (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,828);
...
try {
		Debug.PushSubsStack("ImplUpdateDataFromQuery (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,414);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","910289222",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
;
...
try {
		Debug.PushSubsStack("Initialize (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("lblBack_Click (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,912);
...
try {
		Debug.PushSubsStack("lblBack_MouseClicked (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,933);
...
try {
		Debug.PushSubsStack("lblFirst_Click (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,907);
...
try {
		Debug.PushSubsStack("lblFirst_MouseClicked (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,929);
...
try {
		Debug.PushSubsStack("lblLast_Click (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,917);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.example.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_numberofpages,RemoteObject.createImmutable(1)}, "-",1, 1)),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "*",0, 1)));
...
try {
		Debug.PushSubsStack("lblLast_MouseClicked (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,942);
...
try {
		Debug.PushSubsStack("lblNext_Click (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,923);
...
try {
		Debug.PushSubsStack("lblNext_MouseClicked (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,938);
...
try {
		Debug.PushSubsStack("Refresh (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,183);
...
try {
		Debug.PushSubsStack("Refresh2 (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,192);
...
try {
		Debug.PushSubsStack("RefreshNow (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,188);
...
try {
		Debug.PushSubsStack("RemoveColumnFromCLV (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,290);
...
try {
		Debug.PushSubsStack("ResizeAndReorderCLVItems (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,258);
...
try {
		Debug.PushSubsStack("ResizeColumnImpl (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,300);
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,947);
...
try {
		Debug.PushSubsStack("setCurrentPage (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,903);
...
try {
		Debug.PushSubsStack("SetData (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,654);
...
try {
		Debug.PushSubsStack("setFirstRowIndex (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,883);
...
try {
		Debug.PushSubsStack("SetMouseTransparent (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,757);
...
try {
		Debug.PushSubsStack("SetPageLabelState (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,547);
...
try {
		Debug.PushSubsStack("SetTextOrCSBuilderToLabel (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,764);
...
try {
		Debug.PushSubsStack("SetTextToCell (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,491);
...
try {
		Debug.PushSubsStack("UpdateData (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,329);
...
try {
		Debug.PushSubsStack("UpdateSearchFieldVisibility (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,273);
...
try {
		Debug.PushSubsStack("UpdateSortIcon (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,843);
...
try {
		Debug.PushSubsStack("UpdateTableCounters (b4xtable) ","b4xtable",15,__ref.getField(false, "ba"),__ref,409);
