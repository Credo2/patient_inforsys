...
public static b4j.example.dbutils _dbutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4j.example.b4xcollections.class),"CSSUtils",b4xpages._cssutils,"DateUtils",b4xpages._dateutils,"DBUtils",Debug.moduleToString(b4j.example.dbutils.class),"Delegate",b4xpages._delegate,"GlobalContext",b4xpages._globalcontext,"Main",Debug.moduleToString(b4j.example.main.class),"mPM",b4xpages._mpm,"XUIViewsUtils",Debug.moduleToString(b4j.example.xuiviewsutils.class)};
}
}