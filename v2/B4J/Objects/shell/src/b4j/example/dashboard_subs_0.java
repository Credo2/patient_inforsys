...
_frm2.runClassMethod (b4j.example.view2.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 196;BA.debugLine="ClvMenuDrawer.AddTextItem(\"Home\", Me)";
Debug.ShouldStop(8);
__ref.getField(false,"_clvmenudrawer" /*RemoteObject*/ ).runVoidMethod ("_addtextitem",(Object)(RemoteObject.createImmutable(("Home"))),(Object)(__ref));
 BA.debugLineNum = 197;BA.debugLine="ClvMenuDrawer.AddTextItem(\"Patient List\", frm1)";
Debug.ShouldStop(16);
__ref.getField(false,"_clvmenudrawer" /*RemoteObject*/ ).runVoidMethod ("_addtextitem",(Object)(RemoteObject.createImmutable(("Patient List"))),(Object)((_frm1)));
 BA.debugLineNum = 198;BA.debugLine="ClvMenuDrawer.AddTextItem(\"Input Form\", frm2)";
Debug.ShouldStop(32);
__ref.getField(false,"_clvmenudrawer" /*RemoteObject*/ ).runVoidMethod ("_addtextitem",(Object)(RemoteObject.createImmutable(("Input Form"))),(Object)((_frm2)));
 BA.debugLineNum = 200;BA.debugLine="ClvMenuStatic.AddTextItem(\"Home\", Me)";
Debug.ShouldStop(128);
__ref.getField(false,"_clvmenustatic" /*RemoteObject*/ ).runVoidMethod ("_addtextitem",(Object)(RemoteObject.createImmutable(("Home"))),(Object)(__ref));
 BA.debugLineNum = 201;BA.debugLine="ClvMenuStatic.AddTextItem(\"Patient List\", frm1)";
Debug.ShouldStop(256);
__ref.getField(false,"_clvmenustatic" /*RemoteObject*/ ).runVoidMethod ("_addtextitem",(Object)(RemoteObject.createImmutable(("Patient List"))),(Object)((_frm1)));
 BA.debugLineNum = 202;BA.debugLine="ClvMenuStatic.AddTextItem(\"Input Form\", frm2)";
Debug.ShouldStop(512);
__ref.getField(false,"_clvmenustatic" /*RemoteObject*/ ).runVoidMethod ("_addtextitem",(Object)(RemoteObject.createImmutable(("Input Form"))),(Object)((_frm2)));
