...
Debug.JustUpdateDeviceLine();
b4xfloattextfield.__c.runVoidMethod ("LogImpl","920381720",RemoteObject.createImmutable("Multiline not supported with password mode."),0);
 };
...
try {
		Debug.PushSubsStack("lc_MouseClicked (b4xfloattextfield) ","b4xfloattextfield",24,__ref.getField(false, "ba"),__ref,435);
...
try {
		Debug.PushSubsStack("lc_MousePressed (b4xfloattextfield) ","b4xfloattextfield",24,__ref.getField(false, "ba"),__ref,431);
...
try {
		Debug.PushSubsStack("lc_MouseReleased (b4xfloattextfield) ","b4xfloattextfield",24,__ref.getField(false, "ba"),__ref,440);
