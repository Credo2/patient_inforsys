...
try {
		Debug.PushSubsStack("pnl_MouseClicked (roundslider) ","roundslider",38,__ref.getField(false, "ba"),__ref,161);
...
try {
		Debug.PushSubsStack("pnl_MousePressed (roundslider) ","roundslider",38,__ref.getField(false, "ba"),__ref,157);
...
try {
		Debug.PushSubsStack("pnl_MouseReleased (roundslider) ","roundslider",38,__ref.getField(false, "ba"),__ref,165);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.example.roundslider.class, "_setvalue" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )));
