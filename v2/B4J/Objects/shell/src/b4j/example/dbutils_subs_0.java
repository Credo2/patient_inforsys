...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","935520527",RemoteObject.concat(RemoteObject.createImmutable("CreateTable: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","936438021",RemoteObject.createImmutable("WhereFieldEquals map empty!"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","936438032",RemoteObject.concat(RemoteObject.createImmutable("DeleteRecord: "),_sb.runMethod(true,"ToString")),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","935586051",RemoteObject.concat(RemoteObject.createImmutable("DropTable: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","936110344",RemoteObject.concat(RemoteObject.createImmutable("ExecuteHtml: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","936044809",RemoteObject.concat(RemoteObject.createImmutable("ExecuteJSON: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","936044825",RemoteObject.concat(RemoteObject.createImmutable("Invalid type: "),_dbtypes.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))),0);
 break; }
}
;
 }
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","935782665",RemoteObject.concat(RemoteObject.createImmutable("ExecuteMap: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","935782669",RemoteObject.createImmutable("No records found."),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","935717127",RemoteObject.concat(RemoteObject.createImmutable("ExecuteMemoryTable: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","935651589",RemoteObject.createImmutable("Same Map found twice in list. Each item in the list should include a different map object."),0);
...
dbutils.__c.runVoidMethod ("LogImpl","935651614",RemoteObject.concat(RemoteObject.createImmutable("InsertMaps (first query out of "),_listofmaps.runMethod(true,"getSize"),RemoteObject.createImmutable("): "),_sb.runMethod(true,"ToString")),0);};
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","935651621",BA.ObjectToString(dbutils.__c.runMethod(false,"LastException",dbutils.ba)),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","936372482",RemoteObject.createImmutable("WhereFieldEquals map empty!"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","936372486",RemoteObject.createImmutable("Fields empty"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.__c.runVoidMethod ("LogImpl","936372508",RemoteObject.concat(RemoteObject.createImmutable("UpdateRecord: "),_sb.runMethod(true,"ToString")),0);
