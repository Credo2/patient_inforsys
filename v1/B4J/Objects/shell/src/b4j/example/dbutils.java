...
public static b4j.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4j.example.b4xcollections.class),"B4XPages",Debug.moduleToString(b4j.example.b4xpages.class),"CSSUtils",dbutils._cssutils,"DateUtils",dbutils._dateutils,"DB_BLOB",dbutils._db_blob,"DB_INTEGER",dbutils._db_integer,"DB_REAL",dbutils._db_real,"DB_TEXT",dbutils._db_text,"HtmlCSS",dbutils._htmlcss,"Main",Debug.moduleToString(b4j.example.main.class),"XUIViewsUtils",Debug.moduleToString(b4j.example.xuiviewsutils.class)};
}
}