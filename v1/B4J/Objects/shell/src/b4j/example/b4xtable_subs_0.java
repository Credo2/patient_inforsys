...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","98978452",RemoteObject.createImmutable("closing old db."),0);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","99961542",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
;
