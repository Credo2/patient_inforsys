...
b4xbytesbuilder.__c.runVoidMethod ("LogImpl","91900546",RemoteObject.createImmutable("Index too large"),0);};
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_index,BA.numberCast(double.class, __ref.getField(true,"_mlength" /*RemoteObject*/ )))) { 
b4xbytesbuilder.__c.runVoidMethod ("LogImpl","91966082",RemoteObject.createImmutable("Index too large"),0);};
