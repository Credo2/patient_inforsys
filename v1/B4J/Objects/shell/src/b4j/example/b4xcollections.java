...
public static b4j.example.dbutils _dbutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XPages",Debug.moduleToString(b4j.example.b4xpages.class),"CSSUtils",b4xcollections._cssutils,"DateUtils",b4xcollections._dateutils,"DBUtils",Debug.moduleToString(b4j.example.dbutils.class),"Main",Debug.moduleToString(b4j.example.main.class),"XUIViewsUtils",Debug.moduleToString(b4j.example.xuiviewsutils.class)};
}
}